  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      actions: [
        ...
        FilledButton(onPressed: _handleSubmit, child: const Text('确定')),
      ],
    );
  }
  ...
  Future<void> _handleSubmit() async {
    ...
    if (response != null && response.code == 0) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text(response?.msg ?? '分享失败')));
    }
  }

  String _resolvePermissionValue(PermissionPreset preset, String fallback) {
